  ...
  const updateShipAmount = (shipName, newValue) => {
    switch (shipName) {
      ...
      case "Battleship":
        setShips({
          ...ships,
          battleship: { ...ships.battleship, amount: newValue },
        });
        break;
      case "Cruiser":
      ...
      case "Submarine":
        setShips({
          ...ships,
          submarine: { ...ships.submarine, amount: newValue },
        });
        break;
      case "Destroyer":
        setShips({
          ...ships,
          destroyer: { ...ships.destroyer, amount: newValue },
        });
        break;
    }
  };
    ...
    return (
      <div key={radio.key}>
        <input
          ...
          value={radio.labelName}
          name={radio.type}
          id={radio.id}
          type={radio.type}
          checked={checkedShip == radio.labelName}
        />
        <label htmlFor={radio.id}>
          {radio.labelName} x{getShipAmount(radio.labelName)}
        </label>
      </div>
    );
  });
    ...
    <main className="map-edit-main">
      ...
      <div>
        ...
        <div id="edit-buttons-wrapper">
          ...
          {radios}
          <button onClick={handleClick} id="start-game-btn">
            Start Game
          </button>
        </div>
      </div>
